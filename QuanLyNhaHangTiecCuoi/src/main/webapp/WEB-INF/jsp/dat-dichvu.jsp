...
<h1 class="text-center text-danger">ĐẶT DỊCH VỤ TIỆC CƯỚI</h1>
        ...
        <div class="col-md-3 col-xs-12">
            <div class="card">  
                ...
                <div class="card-body">
                    ...
                    <a href="<c:url value="#"/>" class="btn btn-primary" onclick="addToDatDichvu(${dv.maDV}, '${dv.tenDV}', ${dv.gia})">Đặt dịch vụ</a>
                </div>
            </div>
        </div>
    </c:forEach>
